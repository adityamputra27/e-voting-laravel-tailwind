    ...
    <body>
        ...
        <div class="relative bg-white overflow-hidden">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                        ...
                        <a href="#">
                            ...
                            <img class="h-8 w-auto sm:h-10" src="{{ asset('assets/images/logo.jpg') }}">
                        </a>
                        <div class="-mr-2 flex items-center md:hidden">
                            <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500" id="main-menu" aria-haspopup="true">
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                        ...
                        <a href="#" class="font-medium text-gray-500 hover:text-gray-900">PROFILE ROHIS</a>

                        <a href="#" class="font-medium text-gray-500 hover:text-gray-900">E-VOTING</a>

                        <a href="#" class="font-medium text-green-600 hover:text-green-500">LOGIN</a>
                    </div>
                    </nav>
                </div>
                ...
                <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                    ...
                    <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                        ...
                        <div role="none">
                        <a href="#" class="block w-full px-5 py-3 text-center font-medium text-green-600 bg-gray-50 hover:bg-gray-100" role="menuitem">
                            Log in
                        </a>
                        </div>
                    </div>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    ...
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block xl:inline">E - Voting ROHIS</span>
                        <span class="block text-green-600 xl:inline">SMKN 1 CIANJUR!</span>
                    </h1>
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="{{ asset('assets/images/banner.jpg') }}" alt="">
            </div>
        </div>
        ...
        <div class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 class="text-base text-green-600 font-semibold tracking-wide uppercase">Informasi</h2>
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    Langkah - langkah menggunakan E - Voting ROHIS
                </p>
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="ml-4">
                        <dt class="text-lg leading-6 font-medium text-gray-900">
                        Pilih kandidat anda yang sesuai
                        </dt>
                        <dd class="mt-2 text-base text-gray-500">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
                        </dd>
